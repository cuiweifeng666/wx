...
Page({
  ...
  data: {
    head: {
      ...
      headOff: 'true',
      titleTrue: 'true',
      headRightTitle: '大小奇偶比走势图',
      headLinkUrl: '../attr/attr?type=3d'
    },
    question: {
      off: false,
      title: '大小奇偶比',
      content: '大小、奇偶的比值的组合；如号码168，大小比是：1:2，奇偶比是：1:2，它们的组合为1:2/1:2'
    },
    boxAdd: {
  ...
  onLoad: function (options) {
    ...
    wx.setStorageSync('link', 'https://m.cjcp.com.cn/zst/cjw3d/3d_shuxingzh-dxjo.html')
