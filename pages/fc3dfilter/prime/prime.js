...
Page({
  ...
  data: {
    head: {
      ...
      headOff: 'true',
      titleTrue: 'true',
      headRightTitle: '直选质合走势图',
      headLinkUrl: '../attr/attr?type=3d'
    },
    question: {
      off: false,
      title: '质合',
      content: '约定12357为质、04689为合。质合的组选形态按质合数的出号量分为4种。质合的直选形态按百十个位所出的质合划分为8种形态。'
    },
    y: {
      sel0: {
        area:'0',
      ...
      sel2: {
        area: '2',
        head: '直选分布',
        select: ['质质质', "质质合", '质合质', '质质合', '合质质', '合质合', '合合质','合合合'],
  ...
  onLoad: function (options) {
    wx.setStorageSync('link', 'https://m.cjcp.com.cn/zst/cjw3d/3d_2numdx-zh.html')
  },
