...
Page({
  ...
  data: {
    head: {
      ...
      headOff: 'true',
      titleTrue:'true',
      headRightTitle:'两码差走势图',
      headLinkUrl: '../attr/attr?type=3d'
    },
    question: {
      off: false,
      title: '两码差',
      content: '单注号码任意两位数字相减的绝对值，范围是0～9，可以对应1个（豹子）、2个（组三）或3个（组六）。如果选定4 5 6，那么列出全部两码差含有4或5或6的号码。'
    },
    val:0,
  ...
  onLoad: function (options) {
    ...
    wx.setStorageSync('link', 'https://m.cjcp.com.cn/zst/cjw3d/3d_weishu-bsc.html')
    var box = [];
    for (var i = 0; i < 10; i++) {
      box.push(false);
    }
