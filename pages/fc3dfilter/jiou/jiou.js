...
Page({
  ...
  data: {
    ...
    question: {
      off: false,
      title: '奇偶',
      content: '约定02468为偶、13579为奇。奇偶的组选形态按奇偶数的出号量分为4种。奇偶的直选形态按百十个位所出的奇偶划分为8种形态。'
    },
    y: {
      sel0: {
        area:'0',
      ...
      sel2: {
        area: '2',
        head: '直选分布',
        select: ['奇奇奇', "奇奇偶", '奇偶奇', '奇偶偶', '偶奇奇', '偶奇偶', '偶偶奇','偶偶偶'],
  ...
  onLoad: function (options) {
    wx.setStorageSync('link', 'https://m.cjcp.com.cn/zst/cjw3d/3d_2numdx-jo.html')
  },
