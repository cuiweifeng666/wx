...
Page({
  ...
  data: {
    head: {
      ...
      headOff: 'true',
      titleTrue: 'true',
      headRightTitle: '大中小走势图',
      headLinkUrl: '../attr/attr?type=3d'
    },
    question: {
      off: false,
      title: '大中小',
      content: '约定789为大、3456为中、012为小。大中小的组选形态按小中大的出号量分为10种.大中小的直选形态按百十个位所出的小中大划分为27种形态。'
    },
    y: {
      sel0: {
        area: '0',
  ...
  chooseBtn: function (e) {
    ...
    if (area < 3) {
      ...
      if (Object.keys(that.data.y).length > 4) {
        ...
        console.log(that.data.arr[area][sle].n2.length)
  ...
  onLoad: function (options) {
    wx.setStorageSync('link', 'https://m.cjcp.com.cn/zst/cjw3d/3d_3numshuxing-dzx.html')
  },
