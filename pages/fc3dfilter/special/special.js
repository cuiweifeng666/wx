...
Page({
  ...
  data: {
    head: {
      ...
      headOff: 'true',
      titleTrue: 'true',
      headRightTitle: '大小质合比走势图',
      headLinkUrl: '../attr/attr?type=3d'
    },
    question: {
      off: false,
      title: '大小质合比',
      content: '大小、质合的比值的组合；如号码168，大小比是：1:2，质合比是：1:2，它们的组合为1:2/1:2。'
    },
    boxAdd: {
  ...
  onLoad: function (options) {
    ...
    wx.setStorageSync('link', 'https://m.cjcp.com.cn/zst/cjw3d/3d_shuxingzh-dxzh.html')
